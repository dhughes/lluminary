...
class ContentAnalyzer < Lluminary::Task
  ...
  input_schema do
    ...
    string :content_type,
           description:
             "Type of content to check for (e.g., 'technical', 'emotional', 'persuasive')"
  ...
  output_schema do
    boolean :contains_type,
            description: "Whether the text contains the specified content type"
...
if __FILE__ == $PROGRAM_NAME
  ...
  result = ContentAnalyzer.call(text: text, content_type: "technical")
  ...
  result = ContentAnalyzer.call(text: text, content_type: "emotional")
